...
class Model(ParamzModel, Priorizable):
    ...
    def CCD(self):
        ...
        try:
            ...
            print(
            "Hessian is not positive definite, ensure parameters are at their MAP solution by optimizing, if that doesn't work try modifying the step length parameter")
            return
